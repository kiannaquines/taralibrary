...
class ChartData {
  ...
  ChartData({required this.time, required this.count});
}
...
class _InfoScreenState extends State<InfoScreen>
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: zoneInfo!.chartData.isNotEmpty
                              ...
                              BarChartData(
                                ...
                                barGroups: List.generate(
                                  ...
                                  (index) => BarChartGroupData(
                                    ...
                                    barRods: [
                                      BarChartRodData(
                                        toY: zoneInfo!.chartData[index].count
                                            .toDouble(),
  ...
  void _showCommentForm(BuildContext context) async {
    ...
    if (currentUser == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('You need to log in to leave a comment.'),
          showCloseIcon: true,
          behavior: SnackBarBehavior.floating,
        ),
      );
